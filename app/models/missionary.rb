class Missionary < ActiveRecord::Base
  attr_accessible :missbio, :avatar, :missname, :misscountry, :missfacebook, :misstwitter, :missstory, :missaddress

  validates :missname, presence: true
  validates :missbio, presence: true
  validates :user_id, presence: true
  validates :misscountry, presence: true
  validates :missstory, presence: true
  validates :missaddress, presence: true
